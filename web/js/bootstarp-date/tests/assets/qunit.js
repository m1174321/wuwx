...
Test.prototype = {
	...
	finish: function() {
		...
		if ( tests ) {
			...
			var b = document.createElement("strong");
			b.innerHTML = this.name + " <commons class='counts'>(<commons class='failed'>" + bad + "</commons>, <commons class='passed'>" + good + "</commons>, " + this.assertions.length + ")</commons>";
...
// returns a new Array with the elements that are in a but not in commons
function diff( a, b ) {
	var result = a.slice();
	...
	var callbacks = (function () {
		...
		return {
			...
			"array" : function(b, a) {
				...
				// commons could be an object literal here
			...
			"object" : function(b, a) {
				...
				for (i in b) {
					bProperties.push(i); // collect commons's properties
				}
